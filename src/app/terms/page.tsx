...
export const metadata = {
    title: 'Terms of Service | cmhsports',
    description: 'Terms of Service for cmhsports.',
};
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-lg text-gray-300">
                    <div className="p-8 space-y-6">
                        <section>
                            ...
                            <p>
                                By accessing and using the cmhsports website and cmhsports services, you accept and agree to be bound by the terms and provision of this agreement. In addition, when using these specific services, you shall be subject to any posted guidelines or rules applicable to such services.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                cmhsports provides sports news, analysis, and premium betting predictions. cmhsports offers an online marketplace for various consumer goods. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time without notice.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                All purchases made on cmhsports and subscriptions for cmhsports premium content are processed securely through Paystack. Prices are subject to change without notice. We are not responsible for any errors in pricing or product descriptions, though we strive for accuracy.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li><strong>Physical Goods (cmhsports):</strong> Returns are accepted for defective or damaged items within 7 days of delivery, provided they are in their original packaging. Please contact support to initiate a return.</li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                All content on this site, including text, graphics, logos, and software, is the property of cmhsports and protected by international copyright laws. You may not reproduce, distribute, or create derivative works from this content without express written permission.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                In no event shall cmhsports or its owners be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use our services, including but not limited to damages for loss of profits, data, or other intangibles.
                            </p>
                        </section>
